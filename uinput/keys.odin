...
KEY :: enum {
	...
	LINK_PHONE               = 0x1bf, /* AL Phone Syncing */
	DEL_EOL                  = 0x1c0,
	DEL_EOS                  = 0x1c1,
	INS_LINE                 = 0x1c2,
	DEL_LINE                 = 0x1c3,
	...
	REFRESH_RATE_TOGGLE      = 0x232, /* Display refresh rate toggle */
	...
	ACCESSIBILITY            = 0x24e, /* Toggles the system bound accessibility UI/command (HUTRR116) */
	DO_NOT_DISTURB           = 0x24f, /* Toggles the system-wide "Do Not Disturb" control (HUTRR94)*/
 ...
 *  MACRO_RECORD_START will also emit KEY_MACRO_RECORD_STOP if
 *  MACRO_RECORD_STOP is not advertised, then KEY_MACRO_RECORD_START
